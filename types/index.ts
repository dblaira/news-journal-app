...
import type { LifeDomain } from './ontology'
...
export type { LifeDomain } from './ontology'
export { LIFE_DOMAINS, parseLifeDomains } from './ontology'
...
export interface Entry {
  id: string
  headline: string
  /** Primary ontology / life domain (matches `LifeDomain`). */
  category: LifeDomain
  subheading?: string
  content: string
  mood?: string
  ...
  /** Ontology tags (`life_domain[]` in DB); separate from sidebar category. */
