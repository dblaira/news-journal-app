    ...
    <main className="min-h-screen flex" role="main" aria-label="Authentication">
      ...
      <div className="w-full md:w-1/2 bg-black flex flex-col min-h-screen">
        ...
        <header className="px-6 py-8 md:px-12 lg:px-16 text-center">
          <h1 
            className="text-2xl md:text-3xl tracking-[0.2em] text-white uppercase"
        ...
        <div className="flex-1 flex items-center justify-center px-6 pb-12 md:px-12 lg:px-16">
          <div className="w-full max-w-md">
            {/* Headline */}
            <h2 
              className="text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-10 text-center"
              style={{ fontFamily: "var(--font-bodoni-moda), Georgia, 'Times New Roman', serif" }}
            >
              {isSignUp ? 'Create your account' : 'Welcome back to Understood'}
            </h2>
