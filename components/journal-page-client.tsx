...
export function JournalPageClient({
  ...
  const renderDesktopContent = () => {
    // Exercise domain surfaces workout program
  ...
  return (
    <div className="page-shell">
      ...
      <main className={`hidden lg:block min-h-screen transition-[margin] duration-300 ${
        ...
        {currentEntryType !== 'story' && currentEntryType !== 'note' && currentEntryType !== 'connection' && currentEntryType !== 'action' && currentFilter !== 'Exercise' && (
          <ContentHeader
            entryType={currentEntryType}
            lifeArea={currentFilter}
            issueTagline={issueTagline}
        ...
        {/* Desktop Content */}
        <div
          className={currentEntryType !== 'story' && currentEntryType !== 'note' && currentEntryType !== 'connection' && currentEntryType !== 'action' && currentFilter !== 'Exercise' && !showTimeline ? 'desktop-content-padded' : ''}
        >
          {renderDesktopContent()}
        </div>

        {/* Footer for desktop views not handled by section layouts (not Exercise / workout) */}
        {currentEntryType !== 'story' && currentEntryType !== 'note' && currentEntryType !== 'connection' && currentEntryType !== 'action' && currentFilter !== 'Exercise' && (
