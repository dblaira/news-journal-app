...
import { CreateEntryInput, Entry, EntryType, MAX_IMAGES_PER_ENTRY, EntryImage, LIFE_DOMAINS } from '@/types'
...
const categories: CreateEntryInput['category'][] = [...LIFE_DOMAINS]
