...
export function VanityFairLayout({
  ...
  return (
    <div className="vanity-fair-layout bg-white text-neutral-900 py-10">
      ...
      <div className="px-4 md:px-6 mb-8 max-w-[1400px] mx-auto">
      ...
      {hasPinnedItems && (
        <div className="md:hidden px-4 mb-8 max-w-[1400px] mx-auto">
      ...
      {/* 3-Column Layout */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 px-4 md:px-6 max-w-[1400px] mx-auto">
