...
import { Entry, LIFE_DOMAINS } from '@/types'
...
const categoryTypography: Record<string, CategoryTypography> = Object.fromEntries(
  LIFE_DOMAINS.map((d) => [d, defaultTypography])
) as Record<string, CategoryTypography>
